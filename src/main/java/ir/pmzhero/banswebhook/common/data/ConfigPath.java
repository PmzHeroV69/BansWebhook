...
public final class ConfigPath {
    ...
    public static String PERMANENT_DURATION_TRANSLATION = "permanent-duration-translation";
    ...
    public static String UNBAN_ENABLED = "unban.enabled";
    public static String UNBAN_WEBHOOK_URL = "unban.webhook-url";
    public static String UNBAN_WEBHOOK_TITLE = "unban.webhook-title";
    public static String UNBAN_WEBHOOK_THUMBNAIL = "unban.webhook-thumbnail";
    public static String UNBAN_WEBHOOK_COLOR = "unban.webhook-color";
    public static String UNBAN_FIELDS_SECTION = "unban.fields";

    public static String UNMUTE_ENABLED = "unmute.enabled";
    public static String UNMUTE_WEBHOOK_URL = "unmute.webhook-url";
    public static String UNMUTE_WEBHOOK_TITLE = "unmute.webhook-title";
    public static String UNMUTE_WEBHOOK_THUMBNAIL = "unmute.webhook-thumbnail";
    public static String UNMUTE_WEBHOOK_COLOR = "unmute.webhook-color";
    public static String UNMUTE_FIELDS_SECTION = "unmute.fields";

    public static String UNWARN_ENABLED = "unwarn.enabled";
    public static String UNWARN_WEBHOOK_URL = "unwarn.webhook-url";
    public static String UNWARN_WEBHOOK_TITLE = "unwarn.webhook-title";
